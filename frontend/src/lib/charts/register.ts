...
// module-eval time and throws under Node. Pages that prerender (/, /market/[symbol])
// import chart components, so the heavy libs must only evaluate in the browser via loadChart().
